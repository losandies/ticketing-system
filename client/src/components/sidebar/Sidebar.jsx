...
const Sidebar = () => {
	...
	return (
		<div className="sidebar bg-slate-300 bg-opacity-50 w-96 min-w-96 h-screen p-4">
			...
			<div className="page-navigation flex items-center mb-12">
				<ul className="w-full">
					<button
						id="home"
						className="flex text-xl my-4 p-4 w-full bg-gray-300 bg-opacity-70 rounded-lg"
						onClick={onClick}
					>
						<ImHome
							className="text-3xl"
