	...
	return (
		<>
			<div className="flex flex-col h-full w-full bg-white md:h-screen  md:border-l-2 border-l-gray-300">
				<div className="header flex flex-row w-full h-12 md:h-16 border-b-[1px] mt-8 md:mt-10 border-gray-300">
					<div className="header-title w-full text-2xl ml-6 md:text-3xl md:ml-8 relative bottom-2 ">
						<h1>Projects</h1>
					</div>
